...
String passID;
        ...
        try{
            for (int i=0;i<=200;i++){
                ...
                if(value<max){
                    ...
                    HomePage.jTextField1.setText(this.passID);
                    HomePage.jTextField14.setText(this.passID);
                    HomePage.jTextField19.setText(this.passID);
                    HomePage.jTextField26.setText(this.passID);
                    HomePage.jTextField31.setText(this.passID);
    ...
    private void initComponents() {
        ...
        jProgressBar1.setFont(new java.awt.Font("Forte", 0, 14)); // NOI18N
